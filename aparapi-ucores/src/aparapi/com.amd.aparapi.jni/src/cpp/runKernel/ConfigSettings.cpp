...
// example for AMD ...
// ****************************************************************
REGISTER_PLATFORM_CONFIG(AMD,SOURCE_FLOW | BINARY_FLOW | DEFAULT_FLOW, SOURCE_FLOW, ".abcl", '.');
// ****************************************************************
// example for Intel ...
// ****************************************************************
REGISTER_PLATFORM_CONFIG(Intel,SOURCE_FLOW | BINARY_FLOW | DEFAULT_FLOW, SOURCE_FLOW, ".ibcl", '.');
// ****************************************************************
// example for NVIDIA ...
// ****************************************************************
REGISTER_PLATFORM_CONFIG(NVIDIA,SOURCE_FLOW | BINARY_FLOW | DEFAULT_FLOW, SOURCE_FLOW, ".nbcl", '.');
